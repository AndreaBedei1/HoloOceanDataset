...
from src.utils.convert import pose_to_csv_fields
from src.utils.convert import velocity_to_csv_fields
...
def main():
    ...
    writer = DatasetWriter(DATASET_ROOT, RUN_ID)
